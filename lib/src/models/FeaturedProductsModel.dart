...
class FeatureProductModel {
  ...
  factory FeatureProductModel.fromRawJson(String str) => FeatureProductModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FeatureProductModel.fromJson(Map<String, dynamic> json) => FeatureProductModel(
    id: json["id"],
    name: json["name"],
    weight: json["weight"],
    price: json["price"],
...
class MediumClass {
  ...
  factory MediumClass.fromRawJson(String str) => MediumClass.fromJson(json.decode(str));
